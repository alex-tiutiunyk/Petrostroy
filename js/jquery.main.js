...
function initAnchors() {
    new SmoothScroll({
        anchorLinks: '.slide-btn[href^="#"]:not([href="#"])',
        extraOffset: 460
    });
}
...
function scrollBar(){
	var bar = $('body');
	var fixedClass = 'scroll-active';
	var barTop = bar.offset().top + 100;
...
function initCarouselHeight() {
  var wh1 = $(window).outerHeight(),
      wh2 = wh1;
  $(".works-block, .promo-block, .about-block, .gallery, .aprt-section, #video").css({"height": wh2 + 'px'});
}
...
function initSlideShow() {
	jQuery('.steps-gallery, .materials-gallery').fadeGallery({
		useSwipe: true,
		slides: '.slide',
		switchSimultaneously: true,
		disableWhileAnimating: false,
		pagerLinks: '.pagination li, .switcher li',
		autoRotation: false,
		autoHeight: false,
		switchTime: 2000,
		animSpeed: 600
